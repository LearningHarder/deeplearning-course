...
def run():
    train_dataset = torchvision.datasets.CIFAR100(root='input/data', train=True, download=True)
    val_dataset = torchvision.datasets.CIFAR100(root='input/data', train=False, download=True)
